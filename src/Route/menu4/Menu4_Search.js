...
function Menu4_Search({ parentState }) {
  ...
  const { date_f, date_t, cust_nm, bad_cls_nm, maker_nm, work_cust_nm } =
    inputs;
                ...
                <tr>
                  ...
                  <td className={classes.td} align="center">
                    ...
                    {bad_cls_nm.length > 0 && (
                      <IconButton
                        className={classes.clearIcon}
                        onClick={() => handleClearIcon("bad_cls")}
                      >
                        <ClearIcon fontSize="small" />
                      </IconButton>
                    )}
...
export default React.memo(Menu4_Search);
